...
export function XrosMiniRetroLayout({children, onCheckSpecs}) {
  ...
  const PodCompatibleData = {
    ...
    description:
      'XROS MINI Retro is compatible with the most XROS pod series (except 0.4Ω pods). All XROS PODS have all been upgrade to COREX 3.0 which provides best flavor when SSS 2.0 Tech prevents from leakage.',
    podList: [
      {
        id: 'pod1',
        version: '3ml Version',
