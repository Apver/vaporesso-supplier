  ...
  items: [
    {
      ...
      itemType: 'color',
      primaryColorImages: [
        `${SPEC_IMG}/prix-colors.webp`,
        `${SPEC_IMG}/prix-patch.webp`,
      ],
      primaryColorTitle: [
      ...
      primaryColorImagesMobile: [
        `${SPEC_IMG}/prix-Mob-colors.webp`,
        `${SPEC_IMG}/prix-Mob-patch-1.webp`,
        `${SPEC_IMG}/prix-Mob-patch-2.webp`,
      ],
      primaryColorTitleMobile: [
        ['PRIX CHROME KIT', 'PRIX WHITE KIT', 'PRIX BLACK KIT'],
        ['CHROME PANEL', 'BLACK PANEL', 'METAL HEART(BK) PANEL', 'WHITE PANEL'],
